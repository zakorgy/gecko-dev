...
union RendererInit {
  ...
  static RendererInit LinuxVulkan(void *const& a0,
  ...
  static RendererInit MacosMetal(void *const& a0) {
    RendererInit result;
  ...
  static RendererInit Windows(void *const& a0,
                              void *const& a1) {
    RendererInit result;
  ...
  bool operator==(const RendererInit& aOther) const {
    if (tag != aOther.tag) {
      return false;
    }
    switch (tag) {
